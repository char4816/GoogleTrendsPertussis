...
for (state in statesList){
  ...
  # create histogram to see probable vs non-probable to select top few likely models for averaging
...
write.table(modelAverage, file="estimates_top_models_averaged_AR_corrected.csv", sep=',', row.names = F)#, col.names = statesList)